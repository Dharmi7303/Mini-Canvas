    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getActionCommand().equals("LOGIN"))
        {
            ...
            try {
                ...
                if(i>0)
                    {
                        JOptionPane.showMessageDialog(this.d1, "Login Successful","Status",JOptionPane.INFORMATION_MESSAGE);
                        ...
                        JOptionPane.showMessageDialog(this.d1, "Invalid Username or Password","Status",JOptionPane.ERROR_MESSAGE);
                    d1.t1.setText("");
                    d1.t2.setText("");
                    // break;
                }
        ...
        if(e.getActionCommand().equals("VIEW PROFILE"))
        {
            ...
            // try{
            //     char[] ch = new char[50];
            // FileReader fr = new FileReader("Finaluser.txt");
            // fr.read(ch);
